...
final class UnderscoreRenamePhpDocNodeVisitor extends \RectorPrefix20211020\Symplify\SimplePhpDocParser\PhpDocNodeVisitor\AbstractPhpDocNodeVisitor
{
    /**
    ...
    public function enterNode(\PHPStan\PhpDocParser\Ast\Node $node) : ?\PHPStan\PhpDocParser\Ast\Node
    {
        ...
        $slashedName = '\\' . \RectorPrefix20211020\Nette\Utils\Strings::replace($staticType->getClassName(), '#_#', '\\');
