...
final class Indent
{
    ...
    {
        $match = \RectorPrefix20211020\Nette\Utils\Strings::match($content, self::VALID_INDENT_REGEX);
        if ($match === null) {
    ...
    {
        $match = \RectorPrefix20211020\Nette\Utils\Strings::match($content, self::PARSE_INDENT_REGEX);
