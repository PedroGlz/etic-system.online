 ...
 * @final
 */
class GlobResource implements \IteratorAggregate, \RectorPrefix20211020\Symfony\Component\Config\Resource\SelfCheckingResourceInterface
{
    private $prefix;
    private $pattern;
    private $recursive;
    ...
    public function getIterator() : \Traversable
    {
        ...
        if (!\class_exists(\RectorPrefix20211020\Symfony\Component\Finder\Finder::class)) {
            throw new \LogicException(\sprintf('Extended glob pattern "%s" cannot be used as the Finder component is not installed.', $this->pattern));
        }
        $finder = new \RectorPrefix20211020\Symfony\Component\Finder\Finder();
        $regex = \RectorPrefix20211020\Symfony\Component\Finder\Glob::toRegex($this->pattern);
        if ($this->recursive) {
