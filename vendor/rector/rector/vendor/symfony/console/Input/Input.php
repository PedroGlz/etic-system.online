 ...
 */
abstract class Input implements \RectorPrefix20211020\Symfony\Component\Console\Input\InputInterface, \RectorPrefix20211020\Symfony\Component\Console\Input\StreamableInputInterface
{
    ...
    public function __construct(\RectorPrefix20211020\Symfony\Component\Console\Input\InputDefinition $definition = null)
    {
        if (null === $definition) {
    ...
    public function validate()
    {
        ...
        if (\count($missingArguments) > 0) {
            throw new \RectorPrefix20211020\Symfony\Component\Console\Exception\RuntimeException(\sprintf('Not enough arguments (missing: "%s").', \implode(', ', $missingArguments)));
        }
    }
    /**
     * {@inheritdoc}
