...
if (!\interface_exists(\RectorPrefix20211020\Symfony\Contracts\Translation\LocaleAwareInterface::class)) {
    throw new \LogicException('You cannot use the "Symfony\\Component\\String\\Slugger\\AsciiSlugger" as the "symfony/translation-contracts" package is not installed. Try running "composer require symfony/translation-contracts".');
}
/**
 * @author Titouan Galopin <galopintitouan@gmail.com>
 */
class AsciiSlugger implements \RectorPrefix20211020\Symfony\Component\String\Slugger\SluggerInterface, \RectorPrefix20211020\Symfony\Contracts\Translation\LocaleAwareInterface
{
     ...
     * {@inheritdoc}
     */
    public function slug(string $string, string $separator = '-', string $locale = null) : \RectorPrefix20211020\Symfony\Component\String\AbstractUnicodeString
    {
        ...
        $unicodeString = (new \RectorPrefix20211020\Symfony\Component\String\UnicodeString($string))->ascii($transliterator);
