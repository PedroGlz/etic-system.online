 ...
 */
class HtmlDumper extends \RectorPrefix20211020\Symfony\Component\VarDumper\Dumper\CliDumper
{
    ...
    {
        \RectorPrefix20211020\Symfony\Component\VarDumper\Dumper\AbstractDumper::__construct($output, $charset, $flags);
...
EOHTML
    ...
    public function enterHash($cursor, $type, $class, $hasChild)
    {
        ...
        if ($hasChild) {
            ...
            if ($cursor->refIndex) {
                $r = \RectorPrefix20211020\Symfony\Component\VarDumper\Cloner\Cursor::HASH_OBJECT !== $type ? 1 - (\RectorPrefix20211020\Symfony\Component\VarDumper\Cloner\Cursor::HASH_RESOURCE !== $type) : 2;
    ...
    protected function dumpLine($depth, $endOfValue = \false)
    {
        ...
        if (-1 === $depth) {
            \RectorPrefix20211020\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine(0);
        }
        \RectorPrefix20211020\Symfony\Component\VarDumper\Dumper\AbstractDumper::dumpLine($depth);
    }
