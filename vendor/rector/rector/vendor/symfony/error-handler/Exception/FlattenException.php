...
class FlattenException
{
    ...
    public static function createFromThrowable($exception, $statusCode = null, $headers = []) : self
    {
        ...
        if ($exception instanceof \RectorPrefix20211020\Symfony\Component\HttpKernel\Exception\HttpExceptionInterface) {
            $statusCode = $exception->getStatusCode();
            $headers = \array_merge($headers, $exception->getHeaders());
        } elseif ($exception instanceof \RectorPrefix20211020\Symfony\Component\HttpFoundation\Exception\RequestExceptionInterface) {
            $statusCode = 400;
        }
        if (null === $statusCode) {
            $statusCode = 500;
        }
        if (\class_exists(\RectorPrefix20211020\Symfony\Component\HttpFoundation\Response::class) && isset(\RectorPrefix20211020\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode])) {
            $statusText = \RectorPrefix20211020\Symfony\Component\HttpFoundation\Response::$statusTexts[$statusCode];
        } else {
