 ...
 * @final
 */
class TestSessionListener extends \RectorPrefix20211020\Symfony\Component\HttpKernel\EventListener\AbstractTestSessionListener
{
    private $container;
    public function __construct(\RectorPrefix20211020\Psr\Container\ContainerInterface $container, array $sessionOptions = [])
    {
