...
\RectorPrefix20211020\dump('any string', 123, [\true, \false, null]);
echo "<h2>Dark Mode</h2>\n";
\RectorPrefix20211020\Tracy\Debugger::$dumpTheme = 'dark';
\RectorPrefix20211020\dump('any string');
echo "<h2>Objects</h2>\n";
...
\class_alias('RectorPrefix20211020\\ParentClass', 'ParentClass', \false);
class ChildClass extends \RectorPrefix20211020\ParentClass
{
    private $baz = 'child';
}
\class_alias('RectorPrefix20211020\\ChildClass', 'ChildClass', \false);
$obj = new \RectorPrefix20211020\ChildClass();
$obj->dynamic = 'hello';
$obj->selfReference = $obj;
\RectorPrefix20211020\dump($obj);
echo "<h2>Strings</h2>\n";
