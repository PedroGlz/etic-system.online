...
namespace RectorPrefix20211020\Symplify\EasyTesting\Finder;
...
final class FixtureFinder
{
    ...
    public function __construct(\RectorPrefix20211020\Symplify\SmartFileSystem\Finder\FinderSanitizer $finderSanitizer)
    {
