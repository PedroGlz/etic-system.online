...
class ShouldCallParentMethodsRule implements \PHPStan\Rules\Rule
{
    ...
    public function processNode(\PhpParser\Node $node, \PHPStan\Analyser\Scope $scope) : array
    {
        ...
        if (!$scope->getClassReflection()->isSubclassOf(\RectorPrefix20211020\PHPUnit\Framework\TestCase::class)) {
            return [];
        }
        ...
        if ($parentMethod->getDeclaringClass()->getName() === \RectorPrefix20211020\PHPUnit\Framework\TestCase::class) {
            return [];
        }
