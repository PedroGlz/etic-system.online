...
use RectorPrefix20211020\Symfony\Component\Console\Input\StringInput;
...
CODE_SAMPLE
    ...
    {
        $privatesCaller = new \RectorPrefix20211020\Symplify\PackageBuilder\Reflection\PrivatesCaller();
        return $privatesCaller->callPrivateMethod(new \RectorPrefix20211020\Symfony\Component\Console\Input\StringInput(''), 'tokenize', [$process]);
    }
