...
class StructuredTokenPrinter implements \RectorPrefix20211020\Helmich\TypoScriptParser\Tokenizer\Printer\TokenPrinterInterface
{
    /** @var Yaml */
    private $yaml;
    public function __construct(\RectorPrefix20211020\Symfony\Component\Yaml\Yaml $yaml = null)
    {
        $this->yaml = $yaml ?: new \RectorPrefix20211020\Symfony\Component\Yaml\Yaml();
    }
    /**
