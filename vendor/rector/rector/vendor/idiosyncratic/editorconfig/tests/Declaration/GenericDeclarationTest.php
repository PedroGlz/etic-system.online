...
class GenericDeclarationTest extends \RectorPrefix20211020\PHPUnit\Framework\TestCase
{
    public function testGetName() : void
    {
        $declaration = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\GenericDeclaration('declaration', 'string');
    ...
    public function testGetValue() : void
    {
        ...
        $declaration = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\GenericDeclaration('declaration', '1');
        $this->assertIsInt($declaration->getValue());
        $this->assertSame(1, $declaration->getValue());
        $this->assertSame('1', $declaration->getStringValue());
        $declaration = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\GenericDeclaration('declaration', 'true');
        ...
        $declaration = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\GenericDeclaration('declaration', '1.1');
        $this->assertIsString($declaration->getValue());
