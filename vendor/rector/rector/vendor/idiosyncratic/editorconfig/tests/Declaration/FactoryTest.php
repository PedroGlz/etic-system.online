...
class FactoryTest extends \RectorPrefix20211020\PHPUnit\Framework\TestCase
{
    public function testOfficialDeclarations()
    {
        ...
        $factory = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\Factory();
    ...
    public function testUnsetDeclaration()
    {
        ...
        $this->assertInstanceOf(\RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\UnsetDeclaration::class, $indentSize);
    }
    public function testUnknownDeclaration()
    {
        $factory = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\Factory();
        $justification = $factory->getDeclaration('justification', 'left');
        $this->assertInstanceOf(\RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\GenericDeclaration::class, $justification);
    }
}
