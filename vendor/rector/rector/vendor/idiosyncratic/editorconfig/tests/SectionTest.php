...
class SectionTest extends \RectorPrefix20211020\PHPUnit\Framework\TestCase
{
    public function testGetDeclaration() : void
    {
        $section = new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Section('**/', '*.php', ['indent_size' => '4', 'indent_style' => 'space'], new \RectorPrefix20211020\Idiosyncratic\EditorConfig\Declaration\Factory());
